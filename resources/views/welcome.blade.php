...
<head>
    ...
    <link rel="preload" href="{{url('')}}/frontend/_next/static/5RfoPlsYJBU61bEnl5ly4/pages/index.js?v=2" as="script" />
    <link rel="preload" href="{{url('')}}/frontend/_next/static/5RfoPlsYJBU61bEnl5ly4/pages/_app.js?v=2" as="script" />
    <link rel="preload" href="{{url('')}}/frontend/_next/static/runtime/webpack-35176d94be6ecb1365a6.js?v=2" as="script" />
    <link rel="preload" href="{{url('')}}/frontend/_next/static/chunks/framework.504af639ffd40f515d05.js?v=2" as="script" />
    <link rel="preload" href="{{url('')}}/frontend/_next/static/chunks/commons.19809b0290a3469b536b.js?v=2" as="script" />
    <link rel="preload" href="{{url('')}}/frontend/_next/static/chunks/styles.3443c41ca6d48d8c70aa.js?v=2" as="script" />
    <link rel="preload" href="{{url('')}}/frontend/_next/static/runtime/main-7bd9b8ccbd6e0574322e.js?v=2" as="script" />
</head>
...
<body>
                            ...
                            <div class="col-xl-12">
                                <div class="banner-one__content text-center mb-1"><img src="{{url('')}}/frontend/assets/images/resources/logo.png" class="img-fluid w-25" alt="Awesome Image" />
                                    ...
                                    <p class="banner-one__text">
                                        ...
                                        <!-- -->
                                    </p> <a href="#event" class="banner-one__btn thm-btn mb-5"><span> Get Started </span> </a>
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="accrodion-grp faq-accrodion">
                            <div class="accrodion active">
                                <div class="accrodion-inner">
                                    <div class="accrodion-title">
                                        <h4>Apa itu Computer Science Olympiad (CSO)?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Kompetisi di bidang matematika dan logika yang diperuntukan bagi siswa SMA/SMK sederajat dengan tujuan mendorong siswa untuk meningkatkan minat dan kemampuan di bidang informatika.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="accrodion active">
                                <div class="accrodion-inner">
                                    <div class="accrodion-title">
                                        <h4>Berapa biaya kompetisi ini?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Setiap tim akan dikenakan biaya 50.000,-</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accrodion active">
                                <div class="accrodion-inner">
                                    <div class="accrodion-title">
                                        <h4>Dokumen apa yang dibutuhkan untuk mendaftar Computer Science Olympiad (CSO)?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Hanya memerlukan scan kartu pelajar atau surat keterangan aktif dari sekolah</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="accrodion active">
                                <div class="accrodion-inner">
                                    <div class="accrodion-title">
                                        <h4>Berapa babak yang ada dalam Computer Science Olympiad (CSO)?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Terdapat 3 babak, yaitu Try Out, Penyisihan, dan Final.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="accrodion active">
                                <div class="accrodion-inner">
                                    <div class="accrodion-title">
                                        <h4>Perbedaan mengikuti pendaftaran gelombang 1 dan 2 ?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Peserta yang mendaftar gelombang 1 akan berkesempatan mengikuti tryout dengan hadiah pengembalian dana pendaftaran, sedangkan peserta yang mendaftar gelombang 2 tidak dapat mengikuti Try Out dan langsung mengikuti babak Penyisihan</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script nomodule="" src="{{url('')}}/frontend/_next/static/runtime/polyfills-d038222aac70ab238905.js?v=2"></script>
    <script async="" data-next-page="/" src="{{url('')}}/frontend/_next/static/5RfoPlsYJBU61bEnl5ly4/pages/index.js?v=2"></script>
    <script async="" data-next-page="/_app" src="{{url('')}}/frontend/_next/static/5RfoPlsYJBU61bEnl5ly4/pages/_app.js?v=2"></script>
    <script src="{{url('')}}/frontend/_next/static/runtime/webpack-35176d94be6ecb1365a6.js?v=2" async=""></script>
    <script src="{{url('')}}/frontend/_next/static/chunks/framework.504af639ffd40f515d05.js?v=2" async=""></script>
    <script src="{{url('')}}/frontend/_next/static/chunks/commons.19809b0290a3469b536b.js?v=2" async=""></script>
    <script src="{{url('')}}/frontend/_next/static/chunks/styles.3443c41ca6d48d8c70aa.js?v=2" async=""></script>
    <script src="{{url('')}}/frontend/_next/static/runtime/main-7bd9b8ccbd6e0574322e.js?v=2" async=""></script>
    <script src="{{url('')}}/frontend/_next/static/5RfoPlsYJBU61bEnl5ly4/_buildManifest.js?v=2" async=""></script>
    <script src="{{url('')}}/frontend/_next/static/5RfoPlsYJBU61bEnl5ly4/_ssgManifest.js?v=2" async=""></script>
    <script>
