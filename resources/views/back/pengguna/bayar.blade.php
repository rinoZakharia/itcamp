...
<div class="col-12">
    <div class="card recent-sales overflow-auto">
        ...
        <div class="card-body">
            <h5 class="card-title">Generate Spreadsheet Terkonfirmasi</h5>
            <form action="{{route("admin.grouping")}}">
                @csrf
                <!-- make form group -->
                <div class="form-group">
                    <!-- make label -->
                    <label for="id">ID Sheet</label>
                    <!-- make input -->
                    <input type="text" class="form-control" id="id" name="id" placeholder="Masukkan ID Sheet">
                </div>
                <button type="submit" class="btn btn-sm my-2 btn-success">Buka Spreadsheet</button>
            </form>
        </div>
    </div>
</div>
